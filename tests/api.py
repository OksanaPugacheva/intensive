...
class CRUD:
    ...
    def patch_submenu(self, menu_id, submenu_id, body):
        response = requests.patch(
            f'{self.LOCAL_URL}{self.MENUS_URL}/{menu_id}{self.SUBMENUS_URL}/{submenu_id}', json=body)
        return response
    ...
    def get_dishes(self, menu_id, submenu_id):
        response = requests.get(
            f'{self.LOCAL_URL}{self.MENUS_URL}/{menu_id}{self.SUBMENUS_URL}/{submenu_id}{self.DISHES_URL}')
        return response
